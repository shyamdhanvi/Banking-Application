...
export async function getLoggedInUser() {
  ...
  export const exchangePublicToken = async ({
    ...
    try{
      ...
      //Create a processor token from Dwolla using access token and account ID
      ...
      //Create a bank account using userID, item ID, account ID, access token, funding source URL, sharable ID
